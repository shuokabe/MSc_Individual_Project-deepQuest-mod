...
class TranslationModel(Model_Wrapper):
    ...
    def EncSentVis(self, params):
        ...
        if params.get('VISUAL_FEATURE_METHOD', 'none') == 'time-step':
            ...
            src_annotations_vis = multiply([src_annotations, reshape_red_visual_feature], name='src_annotations_vis')#([src_annotations, reshape_red_visual_feature], axis=1, name='src_annotations_vis')
